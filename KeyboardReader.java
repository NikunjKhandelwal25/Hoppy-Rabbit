...
//All rights reserved
//Contains fix to Warning message 2022
 ...
 */
   public int readInt(String prompt){
      ...
      try {
         ...
         value = Integer.parseInt(s);  //was originally (new Integer(s)).intValue();
      }catch (Exception e){
         System.out.println
 ...
 */
   public double readDouble(String prompt){
      ...
      try {
         s = (buffer.readLine()).trim();
         value = Double.parseDouble(s); // was originally: (new Double(s)).doubleValue();
      }catch (Exception e){
         System.out.println
